namespace Hacked.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "com.LancelotSoftware.Hacked";
    public readonly static string AndroidAppName = "com.LancelotSoftware.Hacked";
