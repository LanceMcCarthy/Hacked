...
using Hacked.DataLayer.Models;
using Newtonsoft.Json;

namespace Hacked.DataLayer.DataServices
{
    public class BeenPwnedService : IDisposable
    {
        ...
        {
            Debug.WriteLine("Check for breaches");
            ...
            {
                Debug.WriteLine("Check for breaches - request constructed");
        ...
        private async Task ValidateRequestDelayAsync()
        {
            ...
            if (timeElapsedSinceLastCall < TimeSpan.FromMilliseconds(1500))
            {
                ...
                // Delay the call until 1.5 seconds has elpased
