...
namespace Hacked.Forms.Portable.Views
{
    ...
    public partial class AboutPage : ContentPage
    {
        ...
        protected override void OnAppearing()
        {
            ...
            //App.((MainPage as RootPage).Detail as NavigationPage).BarBackgroundColor = Color.Teal;
            //App.((MainPage as RootPage).Detail as NavigationPage).BarTextColor = Color.White;
            //App.((MainPage as RootPage).Detail as NavigationPage).CurrentPage.Title = " About";
